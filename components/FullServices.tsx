...
export default function FullServices() {
  ...
  const serviceList = [
    { description: t('fullServices.services.0.description') || 'نقدم خدمات قص الخرسانة بأحدث المعدات.', alt: 'قص الخرسانة' },
    { description: t('fullServices.services.1.description') || 'خدمات تخريم الخرسانة بدقة عالية.', alt: 'تخريم الخرسانة' },
    { description: t('fullServices.services.2.description') || 'معالجة التشققات وإصلاح الهياكل الخرسانية.', alt: 'معالجة التشققات' },
    { description: t('fullServices.services.3.description') || 'إزالة الخرسانة بأمان وسرعة.', alt: 'إزالة الخرسانة' },
    { description: t('fullServices.services.4.description') || 'حلول هندسية متكاملة لمشاريع البناء.', alt: 'حلول متكاملة' }
  ].map((service, index) => ({
    ...service,

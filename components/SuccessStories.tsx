...
export default function SuccessStories() {
  ...
  const stories = [
    {
      title: t('successStories.stories.0.title') || 'فيلا خاصة - الرياض',
      subtitle: t('successStories.stories.0.subtitle') || 'تصميم وتنسيق حديقة منزلية',
      challenge: t('successStories.stories.0.challenge') || 'مساحة ضيقة وتضاريس غير مستوية',
      solution: t('successStories.stories.0.solution') || 'استخدام التدرجات والمستويات لإخفاء العيوب وزيادة المساحة البصرية',
      result: t('successStories.stories.0.result') || 'حديقة خلابة ومتنفس رائع للعائلة'
    }
  ];
